...
<!-- BEGIN: PROJECTS -->
		...
		<div class="panel panel-success<!-- IF {PRJ_ROW_ISBOLD} --> panel-info<!-- ENDIF --><!-- IF {PRJ_ROW_ISTOP} --> panel-primary<!-- ENDIF -->">
			...
			<div class="panel-body">
				<p class="owner small">{PRJ_ROW_OWNER_NAME} | <span class="date">{PRJ_ROW_DATE_STAMP|cot_date('j F Y', $this)}</span> | <span class="region">{PRJ_ROW_COUNTRY} {PRJ_ROW_REGION} {PRJ_ROW_CITY}</span>{PRJ_ROW_EDIT_URL}</p>
