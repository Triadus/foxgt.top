...
<li class="<!-- IF {MSG_ACTIVE} -->uk-active<!-- ENDIF -->">
    <div class="uk-panel-badge uk-badge uk-margin-small-top uk-margin-small-right">{MSG_TIME_AGO}</div>
    <a href="{MSG_DIAOG_URL}" class="uk-grid">
        ...
        <div class="uk-width-2-3">  
            ...
            <div class="uk-text-muted uk-margin-small-top tp-background">{MSG_TEXT}</div>
        </div> 
    </a>
</li>
<!-- END: MSG_LIST -->
