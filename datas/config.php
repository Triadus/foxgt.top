...
$cfg['mysqldb'] = 'logozet_foxgt';		// Database name
...
$cfg['mainurl'] = 'http://foxgt.top';
$cfg['site_id'] = '5f013897274847830ea97cc7b99aeb1c';
$cfg['secret_key'] = 'a8fa6c57ce6738dad7c4918ddd56804f';
...
$cfg['defaulttheme'] = 'foxgt';	// Default theme code. Be SURE it's pointing to a valid folder in ./themes/... !!
...
$cfg['admintheme'] = 'templatespro';			// Put custom administration theme name here
...
$cfg['useremailduplicate'] = TRUE;     // Allow users to register new accounts with duplicate email. DO NOT ENABLE this setting unless you know for sure that you need it or it may make your database inconsistent.
